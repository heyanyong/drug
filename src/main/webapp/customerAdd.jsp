...
<div class="pageContent">
	<form method="post" action="customer/save" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>联系人：</label>
				<input name="contactPerson"   type="text" size="30"/>
			</p>
			<p>
				<label>联系电话：</label>
