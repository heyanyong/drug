...
<div class="pageContent">
	<form method="post" action="supplier/save" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<p>
				<label>客 户 编号号：</label>
				<input name="no" type="text" size="30" value="100001" readonly="readonly"/>
			</p>
			<p>
				<label>客户全称：</label>
			...
			<p>
				<label>简称：</label>
				<input name="simpleName" class="required" type="text" size="30" value="张慧华" alt="请输入客户名称"/>
			</p>
			<p>
				<label>英文名称：</label>
				<input name="englishName" class="required" type="text" size="30" value="张慧华" alt="请输入客户名称"/>
			</p>
			<p>
				<label>开发部门：</label>
